...
wget https://github.com/alir3zai/3x-ui-glass/releases/download/v4.1/3x-ui-glass.tar.gz
...
### معرفی پروژه
3X-UI Glass یک نسخه سفارشی از پنل مدیریت 3X-UI است که با تم شیشه‌ای (Glassmorphism) و امکانات پیشرفته طراحی شده است.

### تغییرات اصلی نسبت به نسخه اصلی
- **تم شیشه‌ای**: ۴ تم مختلف (روشن، تاریک، خیلی تاریک، مشکی)
- **محدودیت IP**: کاربرانی که بیشتر از حد مجاز دستگاه دارند به صورت خودکار قطع می‌شوند
- **خروجی لینک**: انتخاب چند کانفیگ و دریافت لینک ساب و vless همه با هم
- **نمایش کاربران در اینباند**: با کلیک روی هر اینباند کاربران آن نمایش داده می‌شوند
- **منوی مدیریت پیشرفته**: اژدها ASCII + منوی رنگی با ۱۸ گزینه
