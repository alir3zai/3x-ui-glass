...
show_result() {
    get_server_ip
    get_panel_info
    local panel_url="http://${SERVER_IP}:${PANEL_PORT}${PANEL_PATH}"
    local local_url="http://127.0.0.1:${PANEL_PORT}${PANEL_PATH}"
    echo ""
    echo -e "${GREEN}${BOLD}✅  Installation successful!${PLAIN}"
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${PLAIN}"
    echo -e "  🌐 Panel URL : ${GREEN}${panel_url}${PLAIN}"
    echo -e "  📡 Local URL : ${CYAN}${local_url}${PLAIN}"
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${PLAIN}"
    echo -e "  Default username : ${YELLOW}admin${PLAIN}"
    echo -e "  Default password : ${YELLOW}admin${PLAIN}"
    echo -e "  Management       : run ${CYAN}x-ui${PLAIN}"
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${PLAIN}"
    echo ""
